...
function howToUse() {
    explanation = 'How to use: Run `node documentationMapper.js "./client/Components/MaterialSlim/*/index.js" "./client/Components/MaterialSlim/(.+)/index.js" "./client/documentation.js"`';
